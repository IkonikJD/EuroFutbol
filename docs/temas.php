...
if (!isset($varsesion) || empty($varsesion)) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" id="articulos"><a id="volvertemas" class="btn btn-primary btn-success" href="foro.php" role="button">Volver</a>
                    <br><div class="container" id="foro">
                        <?php
                        mostrarTemas($varsesion);
                        ?>
                    </div>
                    <div class="container" id="foro">
                        <?php
                        mostrarRespuestas($varsesion);
                        ?>
                    </div>
                </div>
            </div>
